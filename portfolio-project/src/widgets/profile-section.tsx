        ...
        <div className="lg:col-span-9 space-y-6">
          ...
          <div className="space-y-6 ">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {/* React & JavaScript */}
              <SectionBoxStack imgsrc1="/images/icons/temp2/React-Dark.svg" imgsrc2="/images/icons/temp/js.svg" name1="React" name2="JavaScript" type="prime">
                <span>함수형 컴포넌트와 Hook 기반 개발, Custom Hook을 통한 재사용 로직 분리, useMemo/useCallback을 활용한 성능 최적화가 가능합니다.</span>
              </SectionBoxStack>

              {/* TanStack Query */}
              <SectionBoxStack imgsrc1="/images/icons/temp/tanstack.svg" imgsrc2="/images/icons/temp2/jotai.svg" name1="TanStack Query" name2="Jotai" type="normal">
                <p>useQuery를 통한 서버 데이터 페칭, 쿼리 키 설계 및 캐시 관리 경험 및 Atomic한 전역 상태 관리 가능합니다.</p>
              </SectionBoxStack>

              {/* Django & Spring Boot */}
              <SectionBoxStack imgsrc1="/images/icons/temp/django.svg" imgsrc2="/images/icons/temp/springboot.svg" name1="Django" name2="Spring Boot" type="normal">
                <p>Django/Spring Boot를 활용한 RESTful API 설계, 데이터베이스 모델링 및 비즈니스 로직 구현 경험이 있습니다.</p>
              </SectionBoxStack>
              {/* Next.js & TypeScript */}
              <SectionBoxStack imgsrc1="/images/icons/temp2/NextJS-Dark.svg" imgsrc2="/images/icons/temp2/typescript-blue.svg" name1="Next.js" name2="TypeScript" type="prime">
                <p>App Router와 Pages Router를 활용해 SSR/SSG/ISR 구현을 통한 렌더링 최적화, Dynamic Routing, API Routes 방식을 구현할 수 있습니다.</p>
              </SectionBoxStack>

              {/* Jest & RTL */}
              <SectionBoxStack imgsrc1="/images/icons/temp/jest.svg" imgsrc2="/images/icons/temp2/testing-library-seeklogo.svg" name1="Jest" name2="RTL" type="normal">
                <p>Jest를 활용한 단위 테스트 설계 및 에러 시나리오 검증이 있으며, 컴포넌트 및 컴포넌트 통합 검증이 가능합니다.</p>
              </SectionBoxStack>

              {/* Git */}
              <SectionBoxStack imgsrc1="/images/icons/temp/git.svg" name1="Git" type="normal">
                <p>Git Flow 브랜치 전략 운영 경험이 있으며, 코드 리뷰 및 충돌 해결을 통한 안정적인 협업 워크플로우 구축이 가능합니다.</p>
              </SectionBoxStack>

              {/* Flutter & Dart */}
              <SectionBoxStack imgsrc1="/images/icons/temp/flutter.svg" imgsrc2="/images/icons/temp/dart.svg" name1="Flutter" name2="Dart" type="normal">
                <p>위젯 기반 UI 구성, 상태 관리 및 네비게이션 HTTP 통신을 통한 API 연동, 웹과 모바일 자이원 학습을 위한 경험</p>
              </SectionBoxStack>

              {/* Tailwind CSS */}
              <SectionBoxStack imgsrc1="/images/icons/temp/tailwind.svg" name1="Tailwind CSS" type="normal">
                <p>유틸리티 클래스 기반 스타일링, 반응형 디자인 구현, 커스텀 설정, 애니메이션 및 트랜지션이 가능합니다.</p>
              </SectionBoxStack>

              {/* Jira */}
              <SectionBoxStack imgsrc1="/images/icons/temp/jira.svg" name1="Jira" type="normal">
