    ...
    <div className=" max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <p className="text-foreground leading-relaxed">
              ...
              <br />
              삼세페이지에서의 <span className="text-custompurple font-semibold">정적/동적 데이터</span>를 분리하기 위해 클라이언트 페칭을 적용했습니다.
            </p>
          </div>
        ...
        <div className="relative min-h-[400px] overflow-hidden">
          <Image alt="rollmodel-img" src="/images/projects/rollmodel01.png" fill className="object-contain" quality={85} priority />
        </div>
      </div>
      ...
      <div className="mt-8 space-y-6">
        ...
        <div>
          ...
          <p className="text-foreground leading-relaxed">
            ...
            사용자 경험 개선 방법을 제득했습니다. 또한 기술적 근거를 바탕으로 한 의사결정 능력과 백엔드팀과의 <span className="text-custompurple font-semibold">API 협업</span>을 주도하는 협업 역량을
            크게 향상시킬 수 있었습니다.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="text-foreground leading-relaxed">
            프로젝트의 <span className="text-custompurple font-semibold">복합성성</span>을 관리하기 위해 <span className="text-custompurple font-semibold">MVP</span>를 3단계로 나누어 진행했습니다.
            ...
            <span className="text-custompurple font-semibold">통합 테스트</span>를 진행했습니다. 3단계에서는 예러 처리와 완전한 <span className="text-custompurple font-semibold">기능 통합</span>을
